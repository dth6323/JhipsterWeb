...
import static com.hrm.app.domain.ContractAsserts.*;
...
import com.hrm.app.repository.ContractRepository;
...
class ContractResourceIT {
    ...
    public static Contract createEntity() {
        return new Contract().startDate(DEFAULT_START_DATE).endDate(DEFAULT_END_DATE).status(DEFAULT_STATUS);
    }
    ...
    public static Contract createUpdatedEntity() {
        return new Contract().startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE).status(UPDATED_STATUS);
    }
    ...
    void putExistingContract() throws Exception {
        ...
        updatedContract.startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE).status(UPDATED_STATUS);
