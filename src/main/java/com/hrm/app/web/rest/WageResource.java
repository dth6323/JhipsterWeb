...
import com.hrm.app.repository.WageRepository;
...
/**
 * REST controller for managing {@link com.hrm.app.domain.Wage}.
 */
@RestController
...
public class WageResource {
    ...
    public ResponseEntity<Wage> createWage(@Valid @RequestBody Wage wage) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/wages/" + wage.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, wage.getId().toString()))
            .body(wage);
    }
    ...
    public ResponseEntity<Wage> updateWage(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody Wage wage)
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, wage.getId().toString()))
            .body(wage);
    }
    ...
    public ResponseEntity<Wage> partialUpdateWage(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, wage.getId().toString())
        );
    }
