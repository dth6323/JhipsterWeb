...
/**
 * REST controller for managing {@link com.hrm.app.domain.Payroll}.
 */
@RestController
...
public class PayrollResource {
    ...
    public ResponseEntity<Payroll> createPayroll(@Valid @RequestBody Payroll payroll) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/payrolls/" + payroll.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, payroll.getId().toString()))
            .body(payroll);
    }
    ...
    public ResponseEntity<Payroll> updatePayroll(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, payroll.getId().toString()))
            .body(payroll);
    }
    ...
    public ResponseEntity<Payroll> partialUpdatePayroll(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, payroll.getId().toString())
        );
    }
