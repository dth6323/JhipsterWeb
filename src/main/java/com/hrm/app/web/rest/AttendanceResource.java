...
/**
 * REST controller for managing {@link com.hrm.app.domain.Attendance}.
 */
@RestController
...
public class AttendanceResource {
    ...
    public ResponseEntity<Attendance> createAttendance(@Valid @RequestBody Attendance attendance) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/attendances/" + attendance.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, attendance.getId().toString()))
            .body(attendance);
    }
