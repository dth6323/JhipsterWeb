...
public class SalaryDistributeResource {
    ...
    //private final EmployeeSalaryRespository salaryDistributeRepository;

    //    public SalaryDistributeResource(EmployeeSalaryRespository salaryDistributeRepository) {
